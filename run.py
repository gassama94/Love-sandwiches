...
CREDS = Credentials.from_service_account_file('credss.json')
...
def get_last_5_entries_sales():
    """
    Collects collumn of data from sales worksheet, collecting the 
    last 5 entries for each sandwich and returns the data a
    list of lists
    """
